...
module.exports.logCPU = (options, cpuLoads, logr, thresholds) => {
...
module.exports.logMemory = (options, memPercent, logr, thresholds) => {
  if (options.verbose) {
...
module.exports.logDisk = (options, spacePercent, logr, thresholds) => {
  if (options.verbose) {
...
const onMemTimer = (options) => {
  stats.getMemory((err, memData) => {
    ...
    module.exports.logMemory(options, memPercent, log, thresholdExceeded);
  });
};
...
const onDiskTimer = (options) => {
  stats.getDisk(options, (err, result) => {
    ...
    module.exports.logDisk(options, spacePercent, log, thresholdExceeded);
  });
};

const onCPUTimer = (options) => {
  const allAvgs = stats.getCPU();
  module.exports.logCPU(options, allAvgs, log, thresholdExceeded);
};
...
// export timing methods for other libraries:
module.exports.onMemTimer = onMemTimer;
module.exports.onDiskTimer = onDiskTimer;
module.exports.onCPUTimer = onCPUTimer;
module.exports.onInodeTimer = onInodeTimer;
